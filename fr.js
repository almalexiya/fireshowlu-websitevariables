    ...
    var programs = [
        {
            ...
            title: " Le сourt et lumineux",
            bulletPoints: [
                "Le show de feu: 1 artiste",
                "Durée: 10 minutes",
                "3 types d'accessoires d'incendie",
                "Le costume à diodes électroluminescentes",
                "Spectacle d'étincelles",
            ],
            details: {
                header: "Le сourt et lumineux",
                price: "250",
                description:
            ...
            title: "La fête",
            bulletPoints: [
                "Le show de feu: 1 acteur",
                "3 sorties séparées pour 3-4 minutes",
                "3 types d'accessoires d'incendie",
                "Le costume à diodes électroluminescentes",
                "Spectacle d'étincelles ",
            ],
            ...
            title: "Le mariage lumineux",
            bulletPoints: [
                "Le show de feu: 1 acteur",
                "Durée: 15 minutes",
                "4-5 types d'accessoires d'incendie",
                "Les costumes à diodes électroluminescentes",
                "Grand coeur de feu",
                "Le final pyrotechnique (2 pièces d'accessoires)",
            ],
            details: {
                header: "Le mariage lumineux",
                price: "400",
                description: ``,
                images: [
            ...
            title: "Salutations pour invités",
            bulletPoints: [
                "Le show de feu: 1 acteur",
                "1 heure avec 10 min de pause entre",
                "3-6 types d'accessoires d'incendie",
                "Le costume à diodes électroluminescentes",
                "Improvisation pour n'importe quelle musique de fond",
            ],
            details: {
                header: "Salutations pour invités",
                price: "380",
                description: `Veuillez nous contacter pour plus d'informations`,
                images: [
            ...
            bulletPoints: [
                "Le show de feu: 1 acteur",
                "Durée: 20-25 minutes",
                "6-7 types d'accessoires d'incendie",
                "Les costumes à diodes électroluminescentes",
                "Spectacle d'étincelles",
                "Le final pyrotechnique (3 pièces d'accessoires)",
            ],
            details: {
                header: "Le festival",
                price: "500",
                description: `Le show de feu "le Festival" est un spectacle de feu universel pour tout type d'événements de niveau VIP. Mais la caractéristique principale de ce spectacle de feu est le remplissage pyrotechnique dans toute la pièce!
                Notre spectacle d'étincelles fantastique et l'inscription enflammée à la fin ne laisseront personne oublier ce qu'ils ont vu depuis longtemps`,
                images: [
        ...
        },
        {
            ...
            title: "Signe de feu",
            bulletPoints: [
                "Durée de combustion 2-3 minutes",
                "La hauteur du symbole est presque 1 mètre",
                "Dans la finale du spectacle de feu ou séparément",
            ],
        ...
        },
        {
            ...
            title: "Le show de lumière",
            bulletPoints: [
                "Le show de lumière: 1 acteur",
                "Durée: Des programmes différents sont available",
                "3-4 types d'accessoires diodes électroluminescentes",
                "Les costumes à diodes électroluminescentes",
            ],

            details: {
                header: "Le show de lumière",
                price: "250-380",
                description: "Veuillez nous contacter pour plus d'informations",
                images: [
        ...
        },
        {
            ...
            title: "Le show de drapeaux",
            bulletPoints: [
                "Le show de drapeaux: 1 acteur",
                "Durée: 10 minutes",
                "3-4 types d'accessoires de drapeaux",
                "Les costumes à diodes électroluminescentes",
                "Effets de fumée",
            ],

            details: {
                header: "Le show de drapeaux",
                price: "250",
                description: "Veuillez nous contacter pour plus d'informations",
                images: [
